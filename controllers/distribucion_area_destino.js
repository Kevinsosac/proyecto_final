...
const httpDistribucion_area_destino = {
    ...
    postAgregarDistribucion_area_destino: async (req, res) => {
        try {
            const { Presupuesto_Asignado,Presupuesto_Actual, iddistribucionredArea, idDestino, year } = req.body
            const Distribucion_area_destino = new distribucion_area_destino({ Presupuesto_Asignado,Presupuesto_Actual, iddistribucionredArea, idDestino, year })
